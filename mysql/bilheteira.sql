...
CREATE TABLE `actor`  (
  `actor_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `comment`  (
  ...
  `film` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `film`  (
  ...
  `movie_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `picture` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `seat`  (
  ...
  `y` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `x` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `flag` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `starredin`  (
  `actor` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `film` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `personage` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `ticket`  (
  ...
  `schedule` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
